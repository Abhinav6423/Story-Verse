...
const TopTrendStoryCard = ({ story, idx }) => {
    return (
        <div className="relative w-full group perspective-1000">
            ...
            {/* CARD CONTAINER */}
            <div className="relative z-10 w-full bg-gradient-to-b from-[#1E1E1E] to-[#0A0A0A] rounded-2xl p-2 sm:p-3 border border-white/5 group-hover:border-emerald-500/40 transition-all duration-500 ease-out shadow-xl group-hover:shadow-[0_15px_40px_-10px_rgba(52,211,153,0.25)] group-hover:bg-gradient-to-b group-hover:from-[#222724] group-hover:to-[#0A0A0A]">
                ...
                <div className="relative aspect-[2/3] w-full rounded-xl overflow-hidden bg-zinc-900 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)] ring-1 ring-white/10 group-hover:ring-emerald-500/30 transition-all duration-500">
                    ...
                    {story?.coverImage ? (
                        <LazyLoadImage
                            ...
                            // Added transform-gpu to prevent animation jitter, and origin-center for a balanced zoom
                ...
                <div className="mt-3 sm:mt-4 space-y-2.5 px-1">
                    ...
                    <div className="flex items-start justify-between gap-3">
                        ...
                        {/* Likes Badge: Added hover highlight so social proof catches the eye */}
                    ...
                    <div className="flex items-center gap-2.5">
                        <img
                            ...
                            height="20"
                            loading="lazy"
                            // Added slight avatar scaling on hover to make it feel tactile
                        ...
                        />
                        {/* Readability bump: changed base text from zinc-400 to zinc-300 for better default contrast */}
